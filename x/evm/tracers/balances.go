...
func TraceTransferUseiAndWei(
	...
	value := usei.Amount.Mul(state.SdkUseiToSweiMultiplier).Add(wei).BigInt()
	TraceTransferEVMValue(ctx, hooks, bankKeeper, fromSeiAddr, fromEVMAddr, toSeiAddr, toEVMAddr, value)
}
